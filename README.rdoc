...
Use it in conjunction with the translate_acts_as_translatable_models (link:https://github.com/lassebunk/translate_acts_as_translatable_models) to automatically translate your acts_as_translatable models.
